# Darians Bot - Ultimate Discord Bot

**Darians Bot** is a powerful, feature-rich Discord bot designed to enhance your server experience with comprehensive moderation tools, engaging economy systems, utility features, and much more. Built with modern Discord.js v14 and PostgreSQL for optimal performance and data persistence.

[![Support Server](https://img.shields.io/badge/-Support%20Server-%235865F2?logo=discord&logoColor=white&style=flat-square&logoWidth=20)](https://discord.gg/x8uVW3wK34)
...
- [Support Server](https://discord.gg/x8uVW3wK34)
...
Darians Bot offers a complete suite of tools for Discord server management and community engagement:
...
### Video Tutorial
For a detailed step-by-step setup guide, join our support server:
[**Darians Bot Support Server**](https://discord.gg/x8uVW3wK34)

## Docker Deployment (Recommended)

Darians Bot is fully containerized for easy deployment.

1. **Clone the repository:**
   ```bash
   git clone https://github.com/applycationreply-cloud/darians-bot-v2.git
   cd darians-bot-v2
   ```
...
```bash
docker pull ghcr.io/applycationreply-cloud/darians-bot-v2:main
```
...
3. **Configure Environment Variables**
   ...
   POSTGRES_URL=postgresql://postgres:yourpassword@localhost:5432/darians_bot
   POSTGRES_HOST=localhost
   POSTGRES_PORT=5432
   POSTGRES_DB=darians_bot
   ...
   - If your chosen `PORT` is already used, Darians Bot automatically tries the next port(s)
...
4. **Setup PostgreSQL Database** (Optional but recommended)
   ```bash
   # Create database
   createdb darians_bot

   # If you are using a custom PostgreSQL user, create it and grant access
   createuser your_database_user
   psql -c "ALTER USER your_database_user PASSWORD 'yourpassword';"
   psql -c "GRANT ALL PRIVILEGES ON DATABASE darians_bot TO your_database_user;"
   ```
...
Darians Bot requires the following Discord intents:
- **Guilds**
- **Guild Messages**
- **Message Content**
- **Guild Members**
...
We welcome contributions to Darians Bot! Here's how you can help:
...
Darians Bot is released under the MIT License. See [LICENSE](LICENSE) for details.

## Thank You

Thank you for choosing Darians Bot for your Discord server! We're constantly working to improve and add new features based on community feedback.
